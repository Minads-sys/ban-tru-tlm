...
![Mã QR Đăng nhập Cổng Học sinh & Phụ huynh](public/qr-student-login.png)
...
```mermaid
flowchart TD
    A[Học sinh / Phụ huynh vào Tab 'Cắt suất ăn'] --> B[Chọn Ngày muốn cắt suất]
    B --> C[Nhập Lý do nghỉ ăn]
    C --> D[Bấm 'Gửi yêu cầu']
    D --> E{Kiểm tra tính hợp lệ}
    E -- Quá giờ chốt hoặc Không có lịch ăn --o F[Thông báo lỗi cụ thể]
    E -- Hợp lệ --o G[Tạo yêu cầu: Trạng thái 'Chờ duyệt']
    G --> H[Ban Quản trị / Giáo viên duyệt]
    H --> I[Trạng thái đổi thành 'Đã duyệt' -> Giảm trừ tiền ăn]
```
